...
<body>
  ...
  <section>
    <div class="log_img">
      <div class="box1">
        <h1>𝖀𝖘𝖊𝖗𝖑𝖔𝖌𝖎𝖓 𝖋𝖔𝖗𝖒</h1>
        <form name="login" action="" method="post">
        <b><p style="text-align: center; font-size: 20px;color: #e6d522;">Login as:</p></b>
        ...
        <label for="student" style="color: #e6d522;">Student</label>
          <div class="login">
            ...
            <input class="btn btn-default" type="submit" name="submit" value="𝖑𝖔𝖌𝖎𝖓" style=" width: 80px; height: 35px">
          </div>
          <p>
            <br><br>
            <a href="updatepassword.php">𝕱𝖔𝖗𝖌𝖔𝖙 𝖕𝖆𝖘𝖘𝖜𝖔𝖗𝖉?</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            𝕹𝖊𝖜 𝖙𝖔 𝖙𝖍𝖎𝖘 𝖜𝖊𝖇𝖘𝖎𝖙𝖊?&nbsp;&nbsp;<a href="registration.php">𝖘𝖎𝖌𝖓 𝖚𝖕</a>
          </p>
        </form>
      </div>
    </div>
